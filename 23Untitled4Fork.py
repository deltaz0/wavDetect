...
for topInd in range(4):
    ...
    for subInd in range(4):
        ...
        del fNormVal, fNormTar, fNormVal3, fNormTar3, fbVal, fbTar, fRookVal, fRookTar, fRookValB, fRookTarB, normBNormComp, rookNormComp, rookBRookComp
